      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            {menuItems.map((item) => (
              <Link
                ...
                href={item.href}
                onClick={onClose}
                className="flex items-center space-x-3 px-4 py-3 text-slate-300 hover:text-white hover:bg-slate-800 rounded-xl transition-all duration-200 group"
              >
          ...
          <div className="p-4 border-t border-slate-700">
            {/* User Profile */}
            <div className="flex items-center space-x-3 px-4 py-3 mb-3 bg-slate-800/50 rounded-xl">
