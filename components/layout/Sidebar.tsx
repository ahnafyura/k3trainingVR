              ...
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-blue-300 text-xs truncate">
                    {role === 'admin' ? 'admin@k3.com' : 'NIK: 12345'}
                  </p>
                </div>
              </div>
              <button className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-300 hover:text-red-200 rounded-lg transition-all duration-300">
